...
import 'package:uts_prima_app/item_model.dart';
import 'package:uts_prima_app/currency_flags.dart';
...
class _ListScreenState extends State<ListScreen> {
  static const API_KEY = 'e7c30889efce64347d14143b8c314208';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('UTS-PRIMA PUTRA')),
